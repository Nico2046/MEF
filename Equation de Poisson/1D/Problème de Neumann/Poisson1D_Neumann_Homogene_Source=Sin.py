...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb  6 11:14:44 2025
...
Problème de Neumann homogène : u'(0) = u'(L) = g = 0
"""
...
#=======================
# Relation de compatibilité entre la source f(x) et le problème de Neumann
#=======================
k = 1
L = 2 * k * np.pi
...
g = 0
#=======================
x_0, x_L = 0, L # Domaine de definition
...
def u_exact(x_range):
    C_1 = - 1
    return C_1 * x_range + np.sin(x_range)
